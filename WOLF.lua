...
ControllerAll = false
local ListSudos ={Sudo_Id,5151007856,5151007856,5555555555}  
...
if tonumber(UserId) == 5151007856 then
Status = true
elseif tonumber(UserId) == 5151007856 then
Status = true
elseif tonumber(UserId) == 5555555555 then
Status = true
elseif tonumber(UserId) == 5555555555 then
...
msg.Name_Controller = 'صـاحـب العـظـمـهةة '
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*♕ عذرآ لا تستطيع استخدام الامر على المطور الكينج  *","md",true)  
end
...
local T =[[
⩹┉┉┉┉⊶❲𖥳ᏦᎥΝᏀ𖥳❳⊷┉┉┉┉⩺
 [✨╎➥ᎳᎬᏞᏟΌᎷᎬ ͲΌ ՏΌႮᎡᏟᎬ ᏦᎥΝᏀ⇓](t.me/SOo_KING)
──┈┈┈┄┄╌ 𝒌𝒊𝒏𝒈 ╌╌╌┄┄┈┈┈
 [⚙╎☆ͲᎻᎬ ᏴᎬՏͲ ՏΌႮᎡᏟᎬ ᎬᏀYᏢͲ☆](t.me/SOo_KING)
 ──┈┈┈┄┄╌ 𝒌𝒊𝒏𝒈 ╌╌╌┄┄┈┈┈
 [⚡╎⍅ᎡႮΝ YΌႮᎡ ᏴΌͲ ᎳᎥͲᎻ ႮՏ ΝΌᎳ⍆](t.me/SOo_KING)
⩹┉┉┉┉⊶❲𖥳ᏦᎥΝᏀ𖥳❳⊷┉┉┉┉⩺
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
 [◍ ᏟᎻ"✈➹ՏΌႮᎡՏᎬ ᏦᎥΝᏀ➷◍](t.me/SOo_KING)
━═━═━═━ٰ═━═━═━•
 ]] 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• ¹·ᎠᎬᏙ➢', url = "https://t.me/TR_E2S_ON_MY_MOoN"},{text = '• ²·ᎠᎬᏙ➢', url = "https://t.me/H_E_R_O_V_I_P"}
},
{
{text = 'ᯓ˚₊¹·ᏴΌͲ➣', url = "https://t.me/Bombo190180BOT"},{text = 'ᯓ˚₊²·ᏴΌͲ➣ ', url = "https://t.me/Hero9683bot"}
},
{
{text = '➹ᏦᎥΝᏀ ՏΌႮᎡՏᎬ➷', url = "https://t.me/SOo_KING/408"}
},
}
local msgg = msg_id/2097152/0.5
...
local TestText = "  ❲ Developers KING ❳\n— — — — — — — — —\n ♕*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n♕ *Dev Bio* : [❲ "..Bio.." ❳]"
local msg_id = msg.id/2097152/0.5 
...
if text == '___' or text == '__' or text == '__' then  
local UserId_Info = LuaTele.searchPublicChat("HO_V_I_P")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(UserId_Info.id)
if  bain.bio then
...
if text == 'الكينج' or text == 'كينج' or text == 'المبرمج الكينج' then  
local UserId_Info = LuaTele.searchPublicChat("TR_E2S_ON_MY_MOoN")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(UserId_Info.id)
...
if text == 'المبرمج الكينج ' or text == 'الكينج ' or text == 'المبرمج' then  
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
return LuaTele.sendText(msg_chat_id,msg_id,"*⚠️| حبيبي دا المبرمج الكينج  مش بيموت*","md",true)  
end
...
if tonumber(Message_Reply.sender.user_id) == tonumber(5151007856) then
return LuaTele.sendText(msg_chat_id,msg_id,"*😹| حبيبي دا كينجج صاحب العظمهه مش بيتف علي*","md",true)  
end
if tonumber(Message_Reply.sender.user_id) == tonumber(WOLF) then
return LuaTele.sendText(msg_chat_id,msg_id,"*👾| هذا بوت يهبل*","md",true)  
end
...
if text == "زواج" or text == "رفع زوجتي" or text == "رفع زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if Redis:sismember(Wolf..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_mtzwga[math.random(#rd_mtzwga)]).Reply,"md",true)  
    ...
    if Redis:sismember(Wolf..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
    Redis:srem(Wolf..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
    end
    Redis:sadd(Wolf..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if text == "تاك للزوجات" or text == "الزوجات" then
  local zwgat_list = Redis:smembers(Wolf..msg_chat_id.."zwgat:")
...
data = {
{
{text = ' ❲ ‹ ⚶➹ᏦᎥΝᏀ ՏΌႮᎡՏᎬ➷⚶ ›❳', url = 't.me/SOo_KING/408'}, 
},
}
}
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= ' ❲ ‹ ⚶➹ᏦᎥΝᏀ ՏΌႮᎡՏᎬ➷⚶ ›❳',url="https://t.me/SOo_KING"}}
}
local msg_id = msg.id/2097152/0.5
...
{
{text = 'مـطـور آلسـورس',type = 'text'},{text = 'المطور',type = 'text'},
},
{
...
local ban = LuaTele.getUser(IdUser)
if photo.total_count > 1 then
local ban_ns = '𝚑𝚎𝚛𝚎 𝚊𝚛𝚎 𝚢𝚘𝚞𝚛 𝚙𝚑??𝚝𝚘𝚜'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '- اخفاء الامر ', callback_data =IdUser..'/delAmr'}, 
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'⋆ تم الزواج منها بنجاح ').Reply,"md",true)  
end 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ' ❲ ‹ ⚶➹ᏦᎥΝᏀ ՏΌႮᎡՏᎬ➷⚶ ›❳', url = 't.me/SOo_KING/408'},},}}
